I CHANGED IT SO THAT YOU HAVE TO USE THE .BAT FILE TO INSERT THE API KEY.

THE PURPOSE OF THIS IS BECAUSE USING THE KEY IN THE NODE ITSELF DIRECTLY,
IS NOT SECURE BECAUSE YOU WILL SHARE YOUR API KEY WITH EVERY MEDIA YOU CREATE.
FORCING USERS TO MODIFY THE .BAT LAUNCHER FILE IS THE ONLY SECURE OPTION
SO IT SHOULD BE THE ONLY OPTION AVAILABLE.
